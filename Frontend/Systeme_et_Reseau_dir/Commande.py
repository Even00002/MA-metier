...
class SujetsCommande(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("CPNV HUB - Invite de Commande")
        ...
        ctk.CTkLabel(
            self.card,
            text="Invite de commande",
            font=ctk.CTkFont(size=28, weight="bold"),
            text_color="white"
        ).pack(pady=(30, 20))

        # Texte sujet
        sujet_texte = get_sujet_text("Invite de commande")
