...
def retour(parent):
    ...
    app = ChoixReseau()        # lance la page Choix du sujet
    app.mainloop()

class SujetsGestion(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("CPNV HUB - Gestion Ordinateur")
        ...
        ctk.CTkLabel(
            self.card,
            text="Gestion Ordinateur",
            font=ctk.CTkFont(size=28, weight="bold"),
            text_color="white"
        ).pack(pady=(30, 20))

        # Texte sujet
        sujet_texte = get_sujet_text("Gestion d'ordinateur")
