...
class admin_user_gestionApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("CPNV HUB - Admin gestion des utilisateurs")
        ...
        # === GAUCHE : IMAGE ===
        self.left = ctk.CTkFrame(self, corner_radius=0, width=400, height=600)
        ...
        self.btn_gestionuser = ctk.CTkButton(self.bg_label, text="Gestion des utilisateurs", width=200, fg_color="#019136",
                                      hover_color="#017A5C", command=self.app_user_gestion)
        self.btn_gestionuser.place(relx=0.3, rely=0.4, anchor="nw")


        self.btn_validation = ctk.CTkButton(self.bg_label, text="Validation", width=200, fg_color="#019136",
                                             hover_color="#017A5C", command=self.app_user_gestion)
        self.btn_validation.place(relx=0.3, rely=0.5, anchor="nw")
    ...
    def app_user_gestion(self):
        self.destroy()  # Ferme la fenêtre Signup
        from Frontend.admin_user_gestion import admin_user_gestionApp  # Import local
        app = admin_user_gestionApp()
        app.mainloop()
