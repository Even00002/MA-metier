"""
Nom du fichier   : login_signup.py
...
class LoginApp(ctk.CTk):
    ...
    def show_login_page(self):
        ...
        ctk.CTkButton(self.signup_card, text="SIGN UP", height=42, fg_color="#019136",
                      command=self.show_signup_page).grid(row=1, padx=20, pady=(0, 14), sticky="ew")

    def show_signup_page(self):
        self.clear_right_side()

        # Bouton retour
        back_btn = ctk.CTkButton(self.right, text="← Retour", fg_color="#019136", width=100, command=self.show_login_page)
